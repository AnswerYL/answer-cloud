 ...
 * @className com.answer.file.service.impl.AbstractIFileService
 */
package com.answer.file.service.impl;

import com.answer.common.model.PageResult;
import com.answer.common.oss.model.ObjectInfo;
import com.answer.file.FileUtil;
import com.answer.file.mapper.FileMapper;
 ...
 * @description AbstractIFileService 抽象类
 * 根据answer.file-server.type 实例化具体对象
 * @author answer_wx
