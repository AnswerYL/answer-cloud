 ...
 * @package com.answer.redis.autoconfig
 * @className com.answer.redis.autoconfig.RedisAutoConfigure
 */
package com.answer.common.redis;

import com.answer.common.redis.properties.CacheManagerProperties;
