 ...
 * @package com.answer.redis.template
 * @className com.answer.redis.template.CustomRedisTemplate
 */
package com.answer.common.redis.template;
...
public class CustomRedisTemplate {
    ...
    public CustomRedisTemplate(RedisTemplate<String, Object> redisTemplate) {
