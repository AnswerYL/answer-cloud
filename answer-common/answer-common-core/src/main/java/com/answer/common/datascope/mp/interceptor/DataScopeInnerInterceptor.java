 ...
 * @package com.answer.common.datascope.mp.interceptor
 * @className com.answer.common.datascope.mp.interceptor.DataScopeInnerInterceptor
 */
package com.answer.common.datascope.mp.interceptor;
...
import static com.answer.common.datascope.mp.sql.handler.SqlHandler.ALIAS_SYNBOL;
...
public class DataScopeInnerInterceptor implements InnerInterceptor {
    ...
    public void beforeQuery(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) {
        //为空时：所有sql都添加权限控制 || 有值时：只有配置的sql添加权限控制
     ...
     * @param selectBody
     */
    private <T extends SelectBody> void reform(SelectBody selectBody) throws JSQLParserException {
            ...
            if (StrUtil.isNotBlank(scopeWhereSql)) {
                ...
                if (fromItem instanceof Table) {
                    ...
                    if (tableInfoMap.containsKey(upperTableName)) {
                        if (!tableInfoMap.get(upperTableName).getIsIgnore()) {
                    ...
                    for (Join join : joinList) {
                        if (join.getRightItem() instanceof Table) {
                            ...
                            if (tableInfoMap.containsKey(joinTable)) {
                                if (!tableInfoMap.get(joinTable).getIsIgnore()) {
