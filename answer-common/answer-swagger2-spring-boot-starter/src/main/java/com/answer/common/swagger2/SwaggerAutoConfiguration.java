 ...
 * @package com.answer.common.swagger2
 * @className com.answer.common.swagger2.SwaggerAutoConfiguration
 */
package com.answer.common.swagger2;
...
public class SwaggerAutoConfiguration implements BeanFactoryAware {
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(name = "answer.swagger.enabled", matchIfMissing = true)
