 ...
 * @package com.answer.common.es.config
 * @className com.answer.common.es.config.RestAutoConfigure
 */
package com.answer.common.es.config;

import com.answer.common.es.properties.RestClientPoolProperties;
