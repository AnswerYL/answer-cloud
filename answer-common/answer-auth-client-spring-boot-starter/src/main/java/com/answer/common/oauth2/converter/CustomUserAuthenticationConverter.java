 ...
 * @package com.answer.common.oauth2.converter
 * @className com.answer.common.oauth2.converter.CustomUserAuthenticationConverter
 */
package com.answer.common.oauth2.converter;
 ...
 * @description 优化自org.springframework.security.oauth2.provider.token.DefaultUserAuthenticationConverter
 * jwt返回的principal改为返回SysUser，增加扩展字段
 * @author answer_wx
 * @date 2024/1/19 19:06
 * @version 1.0
 */
