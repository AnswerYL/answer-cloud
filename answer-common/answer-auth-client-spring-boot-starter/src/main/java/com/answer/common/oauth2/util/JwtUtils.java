 ...
 * @package com.answer.common.oauth2.util
 * @className com.answer.common.oauth2.util.JwtUtils
 */
package com.answer.common.oauth2.util;

import com.answer.common.constant.SecurityConstants;
import com.answer.common.utils.JsonUtil;
import com.answer.common.utils.RSAUtil;
...
public class JwtUtils {
    ...
    public static RSAPublicKey getPubKeyObj() {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(res.getInputStream()))) {
            ...
            return RSAUtil.getPublicKey(pubKey);
        } catch (Exception ioe) {
            ioe.printStackTrace();
        }
        return null;
