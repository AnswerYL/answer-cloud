 ...
 * @className com.answer.common.lb.config.FeignHttpInterceptorConfig
 */
package com.answer.common.lb.config;
 ...
 * @description feign拦截器，只包含http数据
 * @author answer_wx
...
public class FeignHttpInterceptorConfig {
    ...
    public void initialize() {
        ...
        requestHeaders.add(CommonConstant.ANSWER_VERSION);
    }

    /**
     * 使用feign client访问别的微服务时，
     * 将上游传过来的access_token、username、roles等信息放入header传递给下一个服务
     */
    @Bean
