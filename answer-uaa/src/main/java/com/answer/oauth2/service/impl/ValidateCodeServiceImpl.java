 ...
 * @className com.answer.oauth2.service.impl.ValidateCodeServiceImpl
 */
package com.answer.oauth2.service.impl;
...
import com.answer.oauth2.exception.ValidateCodeException;
...
public class ValidateCodeServiceImpl implements IValidateCodeService {
    ...
    public void saveImageCode(String deviceId, String imageCode) {
        customRedisTemplate.setExpire(buildKey(deviceId), imageCode, SecurityConstants.DEFAULT_IMAGE_EXPIRE);
    }
    ...
    public Result sendSmsCode(String mobile) {
        Object tempCode = customRedisTemplate.get(buildKey(mobile));
        if (tempCode != null) {
        ...
        customRedisTemplate.setExpire(buildKey(mobile), code, SecurityConstants.DEFAULT_IMAGE_EXPIRE);
    ...
    public String getCode(String deviceId) {
        return (String)customRedisTemplate.get(buildKey(deviceId));
    }
    ...
    public void remove(String deviceId) {
        customRedisTemplate.del(buildKey(deviceId));
    }
