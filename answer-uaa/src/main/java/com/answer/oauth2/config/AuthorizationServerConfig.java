 ...
 * @className com.answer.oauth2.config.AuthorizationServerConfig
 */
package com.answer.oauth2.config;
...
import com.answer.common.oauth2.constants.IdTokenClaimNames;
...
import com.answer.oauth2.service.impl.RedisClientDetailsService;
import com.answer.oauth2.service.impl.UserDetailServiceFactory;
import com.answer.oauth2.utils.OidcIdTokenBuilder;
